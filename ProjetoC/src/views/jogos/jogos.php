...
<body>
    ...
    <main class="container mt-4">
        ...
        <a href="/jogos/inserir" class="btn btn-steam mb-3">Novo jogo</a>
        ...
        <table class="table table-striped table-hover" id="tabela">
            ...
            <tbody>
                <!-- Mostrar todas as descrições da tabela Jogos -->
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?=$c['preco']?></td>
                            <td>
                                <a href="/jogos/alterar/id/<?=$c["id"]?>" class="btn btn-warning">Alterar</a>
                                <a href="/jogos/excluir/id/<?=$c["id"]?>" class="btn btn-danger">Excluir</a>
                            </td>
                        </tr>
                    <?php
                    }
