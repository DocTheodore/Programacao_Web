...
<body>
    ...
    <main class="container mt-4">
        ...
        <a href="/eventos/inserir" class="btn btn-steam mb-3">Novo evento</a>
        ...
        <table class="table table-striped table-hover" id="tabela">
            ...
            <tbody>
                <!-- Mostrar todas as descrições da tabela Eventos -->
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?=$c['fim']?></td>
                            <td>
                                <a href="/eventos/alterar/id/<?=$c["id"]?>" class="btn btn-warning">Alterar</a>
                                <a href="/eventos/excluir/id/<?=$c["id"]?>" class="btn btn-danger">Excluir</a>
                            </td>
                        </tr>
                    <?php
                    }
