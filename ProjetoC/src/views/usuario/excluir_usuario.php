        ...
        <input type="hidden" name="id" value="<?=$resultado["id"]?>">
            ...
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <input disabled type="number" name="idade" class="form-control" value="<?=$resultado["idade"]?>">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-6">
                    <label for="pais" class="form-label">Pais de origem:</label>
                    <input disabled type="text" name="pais" class="form-control" value="<?=$resultado["pais"]?>">
                </div>
            </div>
            <div class="row">
                <div class="col">
