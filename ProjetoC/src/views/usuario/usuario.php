...
<body>
    ...
    <main class="container mt-4">
        ...
        <a href="/usuario/inserir" class="btn btn-steam mb-3">Novo usuario</a>
        ...
        <table class="table table-striped table-hover" id="tabela">
            ...
            <tbody>
                <!-- Mostrar todas as descrições da tabela usuario -->
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?=$c['pais']?></td>
                            <td>
                                <a href="/usuario/alterar/id/<?=$c["id"]?>" class="btn btn-warning">Alterar</a>
                                <a href="/usuario/excluir/id/<?=$c["id"]?>" class="btn btn-danger">Excluir</a>
                            </td>
                        </tr>
                    <?php
                    }
